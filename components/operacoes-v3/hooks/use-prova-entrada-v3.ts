...
import type { AcessorioEntradaV3 } from "@/lib/operacoes-v3/prova-entrada-model";

export type ProvaAcaoV3 = "prova" | "acessorios" | "foto" | "removerFoto";
...
export function useProvaEntradaV3(
  ...
  return { pending, error, salvarProva, salvarAcessorios, adicionarFoto, removerFoto };
}
