    ...
    <div className="space-y-6">
      ...
      <div className="glass-card rounded-2xl p-6 animate-fade-in-up [animation-delay:80ms]">
        <div className="flex items-start gap-4">
          <div className="relative">
            <div className="rounded-xl bg-muted p-3 text-primary animate-neon-pulse">
              <AlertTriangle className="h-6 w-6" />
            </div>
          </div>
          <div className="flex-1">
            <div className="flex flex-wrap items-center gap-2">
              <h3 className="text-2xl font-semibold text-primary">Alerta da IA Mestre</h3>
      ...
      <div className="glass-card rounded-2xl p-5 animate-fade-in-up [animation-delay:160ms]">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-base font-semibold text-primary">Créditos de IA</p>
