...
import { Progress } from "@/components/configuracoes/lovable/ui/progress";
        ...
        <SettingsCard title="Automação" description="Ativações reais serão integradas depois.">
          <div className="space-y-2">
            {["Sugestões de texto", "Geração de imagem", "Resumo de relatórios"].map((it) => (
              <div key={it} className="flex items-center justify-between rounded-xl border border-border bg-card/60 px-4 py-3">
