        ...
        <>
          ...
          <ul className="flex-1 border-t border-border sm:border-t-0">
            {filtradas.map((l) => {
              ...
              const titulo = venda ? (l.cliente ?? "Cliente não identificado") : CATEGORIA_LABEL[l.categoria]
              const sub = venda || l.descricao === CATEGORIA_LABEL[l.categoria] ? l.origemLabel : l.descricao
