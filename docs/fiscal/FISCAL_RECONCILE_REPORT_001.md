...
O banco configurado contém as oito tabelas fiscais esperadas, todas sem registros fiscais. Há 721
vendas e nenhuma com estado fiscal. O diff Prisma 6.19.3 retornou migração vazia; não há drift entre
o datamodel e o banco consultado. Nenhum documento fiscal foi homologado ou emitido em produção.
...
- Vendas cresceram de 719 para 721; ambas as novas permanecem `NAO_FISCAL`.
