# Migração — remoção do prefixo `gc-` de `Produto.sku`

> Gerado por `scripts/remover-gc-skus.ts` em 2026-05-24T14:13:53.143Z.
> Modo: **APPLY (gravado no banco)**.
...
| **Alterados** | **232** |
| Conflitos (pulados) | 1 |
| Sem SKU final válido (pulados) | 0 |
| Tempo de execução | 6699ms |
