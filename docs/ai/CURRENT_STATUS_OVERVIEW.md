...
| 1 | **Estoque** | 🟢 ledger maduro | Ledger profissional ✅, importador defensivo ✅, saneamento SKU ✅; **BL-07 Fase 1 (Fundação) 🔄 em andamento** — models/migração `0011`/services/backfill escritos, vitest **14/14**, `tsc`/`build` pendentes | 🟠 multi-depósito sendo fundado (cache `Produto.stock` intacto; consumidores cabeados na Fase 2) |
