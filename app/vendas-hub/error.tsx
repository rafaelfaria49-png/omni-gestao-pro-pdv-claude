...
export default function VendasHubError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[vendas-hub] boundary error:", error.message, error.digest)
  }, [error])
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6 py-24 px-6 text-center">
      ...
      <div className="space-y-1">
        <h2 className="text-lg font-semibold text-foreground">Falha ao carregar o Vendas HUB</h2>
